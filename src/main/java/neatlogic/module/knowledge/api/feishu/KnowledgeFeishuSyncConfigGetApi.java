...
public class KnowledgeFeishuSyncConfigGetApi extends PrivateApiComponentBase {
    @Resource
    private KnowledgeFeishuSyncService knowledgeFeishuSyncService;
    @Override
    public String getToken() { return "knowledge/feishu/sync/config/get"; }
    @Override
    public String getName() { return "获取飞书云文档同步配置"; }
    @Override
    public String getConfig() { return null; }
    @Input({@Param(name = "id", type = ApiParamType.LONG, isRequired = true, desc = "id")})
    @Description(desc = "获取飞书云文档同步配置")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        return knowledgeFeishuSyncService.getConfig(jsonObj.getLong("id"));
    }
}
