...
public class KnowledgeFeishuSyncAuditSearchApi extends PrivateApiComponentBase {
    @Resource
    private KnowledgeFeishuSyncService knowledgeFeishuSyncService;
    @Override
    public String getToken() { return "knowledge/feishu/sync/audit/search"; }
    @Override
    public String getName() { return "查询飞书云文档同步记录"; }
    @Override
    ...
    @Description(desc = "查询飞书云文档同步记录")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        return knowledgeFeishuSyncService.searchAudit(JSON.toJavaObject(jsonObj, KnowledgeFeishuSyncAuditVo.class));
    }
}
